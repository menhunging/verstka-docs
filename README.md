...
В первую очередь устанавливаем "Prettier - Code formatter". Большая часть инфы описанное ниже делается автоматически. Например ; в файлах js проставляется автоматичеки.
